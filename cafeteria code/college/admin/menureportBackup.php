            ...
            <div class="container-fluid">
               ...
               <table id="example1" class="table table-bordered table-responsive">
                           ...
                           <?php
                                ...
                                $sql = "SELECT foodid,foodname,menufood.created_at,FirstName,SecondName,lastname FROM food right join menufood on menufood.id =food.foodid LEFT JOIN cafereriaowner on menufood.createdBY = cafereriaowner.id";                                       
                           ...
                           <?php
                                          ...
                                          $sql = "SELECT foodname,deletedmenu.deletedAt,FirstName,SecondName,lastname FROM food right join deletedmenu on deletedmenu.deletedFoodId =food.foodid LEFT JOIN cafereriaowner on deletedmenu.deletedBY = cafereriaowner.id";                                    
                                          if($sqlResult = mysqli_query($con,$sql))
                                          {
                                             if(mysqli_num_rows($sqlResult)>0)
                                             {
