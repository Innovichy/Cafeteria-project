               ...
               <div class="container-fluid">
                    ...
                    <table class="table col-md-6 m-auto border-right border-primary stripped" id="customerinfo">
                        ...
                        <tbody>
                           ...
                           $sql ='SELECT   foodname, amount,gender FROM food RIGHT JOIN foodreport on food.foodId = foodreport.foodReportId LEFT JOIN customer on customer.cardNumber = foodreport.cardnumber WHERE food.foodId ="'.$food.'"  and  ticket_status=1  group by customer.cardNumber' ;
