               ...
               <div class="container-fluid">
                    ...
                    <table class="table col-md-10 m-auto" id="customerinfo">
                        ...
                        <tbody>
                              ...
                              $sql ="SELECT food.foodId , foodname,day(foodreport.createdAt) as day,sum(amount) as amount FROM food RIGHT JOIN foodreport on food.foodId = foodreport.foodReportId 
