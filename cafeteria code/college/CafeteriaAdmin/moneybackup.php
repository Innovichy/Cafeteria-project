   ...
   <div class="wrapper">
    ...
    if(isset($_POST['YearMonthsubmit']))
    {
        ...
        //   $sqlfood = "SELECT  amount FROM food   RIGHT JOIN  foodreport on food.foodId = foodreport.foodReportId where date(foodreport.createdAt) =\"2023-06-23\"";
          $sqlfood = 'SELECT day(foodreport.createdAt) as day,sum(amount) as amount FROM food RIGHT JOIN foodreport on food.foodId = foodreport.foodReportId where year(foodreport.created_at) ="'.$year.'" and month(foodreport.created_at)="'.$themonth.'"
     ...
     <div class="card-body text-center">
      ...
      <div class="card-body">
        <div class=" text-center">
            <p>Today's Usage</p>
           <?php
           $sql = "SELECT  amount FROM food   RIGHT JOIN  foodreport on food.foodId = foodreport.foodReportId where date(foodreport.createdAt) =\"2023-06-23\"";
